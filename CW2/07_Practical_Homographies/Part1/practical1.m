...
noiseLevel = 4.0;
pts2Cart = pts2Cart+noiseLevel*randn(size(pts2Cart)) %x
...
%TO DO 1 add a scaling parameter: lambda, the result of pts2EstHom remains
%the same
lambda=randn(1,1);
pts2EstHom = lambda*HEst*pts1Hom
