...
how_many_of_each = histc(samples_to_propagate, unique(samples_to_propagate)); %return the freq. of every unique sample index
...
particles_new = zeros( size(particles_old) ); %numParticles*2
